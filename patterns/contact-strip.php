<?php
/**
 * Title: Contact and Recruiting Strip
 * Slug: anee-ollie-child/contact-strip
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted)">Invite prospective students, postdocs, and collaborators to get in touch. This section is also a good home for contact details if you want the footer itself to stay quiet.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link wp-element-button" href="/people/">Explore openings</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
