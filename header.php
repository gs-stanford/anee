...
<head>
	...
	$boies_asset_css = get_stylesheet_directory() . '/assets/css/anee.css';
	?>
	<?php wp_head(); ?>
	...
	<link rel="stylesheet" href="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/css/anee.css' ); ?>?ver=<?php echo esc_attr( file_exists( $boies_asset_css ) ? filemtime( $boies_asset_css ) : wp_get_theme()->get( 'Version' ) ); ?>">
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
